...
function navTab(value){
    ...
    document.getElementById("education").classList.remove('single-tab-area');

    document.getElementById("professional").classList.remove('show');
    document.getElementById("professional").classList.remove('active');
    document.getElementById("professional").classList.remove('single-tab-area');

    document.getElementById("training").classList.remove('show');
    document.getElementById("training").classList.remove('active');
    document.getElementById("training").classList.remove('single-tab-area');

    document.getElementById("experience").classList.remove('show');
    document.getElementById("experience").classList.remove('active');
    document.getElementById("experience").classList.remove('single-tab-area');
    ...
    if(value=="education"){
        ...
        document.getElementById("education").classList.add('single-tab-area');

    }else if(value=="professional"){
        document.getElementById("professional-tab").classList.add('active');

        document.getElementById("professional").classList.add('show');
        document.getElementById("professional").classList.add('active');
        document.getElementById("professional").classList.add('single-tab-area');
        ...
        document.getElementById("training").classList.add('single-tab-area');
        ...
        document.getElementById("experience").classList.add('single-tab-area');
    }
}
